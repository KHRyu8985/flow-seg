...
Usage:
    python scripts/train_flow_model.py --config configs/flow/flowsdf.yaml

Script (nohup bash):
nohup bash -c 'source .venv/bin/activate && uv run python scripts/train_flow_model.py --config configs/flow/flowsdf.yaml' > scripts/logs/flowsdf_train.log 2>&1 &
"""
...
from src.archs.flow_model import FlowSDFModel
