...
class FlowCoordModel(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Prepare 4-channel input: [image, noise, coordx, coordy]
        ...
        target_4ch = torch.cat([target_image, geometry, coordx, coordy], dim=1)
        
        # Random patch extraction
        input_4ch, target_4ch = random_patch_batch(
            [input_4ch, target_4ch], patch_size, num_patches
        )
