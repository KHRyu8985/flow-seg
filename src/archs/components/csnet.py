"""CSNet: Channel and Spatial CSNet Network.
Based on original implementation: https://github.com/iMED-Lab/CS-Net
"""
...
class CSNetBase(nn.Module):
    """Original CSNet implementation."""
...
class CSNet(nn.Module):
    """Wrapper for CSNetBase with simplified interface."""
    ...
    def __init__(
        ...
        super().__init__()
        self.model = CSNetBase(classes=num_classes, channels=in_channels)
...
if __name__ == "__main__":
    ...
    model = CSNet(in_channels=1, num_classes=2).to(device)
    model.eval()
